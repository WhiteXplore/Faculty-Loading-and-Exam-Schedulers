...
export default {
  ...
  watch: {
    ...
    "form.institute_id"() {
      this.form.program_id = ""; // reset if institute changes
    },
  },
  methods: {
    ...
    async submitData() {
      const formElement = this.$refs.instructorForm;
    ...
    populateForm() {
      if (this.instructorData) {
        this.form = {
          instructor_id: this.instructorData.instructor_id || "",
          ...
          program_id: this.instructorData.program_id || "",
          institute_id: this.instructorData.institute_id || "",
          instructor_expertise: this.instructorData.expertise
            ? this.instructorData.expertise.map((e) => e.expertise)
            : [],
        };
      }
    },
